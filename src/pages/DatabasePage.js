...
function DatabasePage() {
  const databaseServices = [
    {
      id: 'dbmy',
      title: 'Databases MySQL (DBMy)',
      description: 'Comprehensive troubleshooting guides for DBMy services including RDS MySQL, Aurora MySQL, MariaDB, SQL Server, and Database Migration Services',
      icon: '🐬',
      route: '/coming-soon',
      color: '#4285f4',
      available: false
    ...
    {
      id: 'dbpo',
      title: 'Databases PostgreSQL (DBPo)',
      description: 'Comprehensive troubleshooting guides for DBPo services including RDS PostgreSQL, Aurora PostgreSQL, Oracle, DocumentDB, and Timestream',
      icon: '🐘',
      route: '/coming-soon',
      color: '#34a853',
      available: false
  ...
  return (
    <div className="page-content">
      <Header 
        ...
        subtitle="Databases MySQL (DBMy) and Databases PostgreSQL (DBPo) troubleshooting categories"
        ...
        logoAlt="AWS Database Troubleshooting"
      />
        ...
        <div className="home-page">
          <div className="home-intro-section">
            <p className="home-intro">
              Choose your specific database troubleshooting category to access detailed guides and solutions
            </p>
          </div>
